...
public class CompleteValueRecyclerAdapter extends RecyclerView.Adapter<CompleteValueRecyclerAdapter.ViewHolder> {

    private Context mContext;
    private List<CallLogModel> mCallLogs;

    public CompleteValueRecyclerAdapter(Context context, List<CallLogModel> feedback) {
        mContext = context;
        mCallLogs = feedback;
    }
