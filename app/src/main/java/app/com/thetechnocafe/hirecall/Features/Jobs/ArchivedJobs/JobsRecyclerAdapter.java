...
public class JobsRecyclerAdapter extends RecyclerView.Adapter<JobsRecyclerAdapter.ViewHolder> {
    ...
    public interface OnJobSelectedListener {
        ...
        void onUnArchiveClicked(JobModel job);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        void bindData(int position) {
            ...
            mThreeDotMenuImageView.setOnClickListener(view -> {
                ...
                menu.getMenuInflater().inflate(R.menu.menu_popup_unarchive, menu.getMenu());
                menu.setOnMenuItemClickListener(item -> {
                    switch (item.getItemId()) {
                        case R.id.unarchive: {
                            if(mListener != null) {
                                mListener.onUnArchiveClicked(mJobList.get(getAdapterPosition()));
                            }
                            menu.dismiss();
                            return true;
                        }
